...
进入 [github.com/pylectra/pylectra](https://github.com/pylectra/pylectra)（示例 URL），你会看到：
...
进入 [Releases](https://github.com/pylectra/pylectra/releases)，找到最新版本，点 **Source code (zip)** 下载，解压。然后照常 `pip install -e .`。
